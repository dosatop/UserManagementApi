...
namespace UserManagementApi.Migrations
{
    ...
    [Migration("20260909124308_RemoveTermFromAcademicSessions")]
    partial class RemoveTermFromAcademicSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcademicTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AcademicSessionId", "IsCurrent");

                    b.HasIndex("AcademicSessionId", "Term")
                        .IsUnique();
            ...
            modelBuilder.Entity("UserManagementApi.Models.AcademicSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "Session")
                        .IsUnique();

                    b.ToTable("AcademicSessions");
                });

            modelBuilder.Entity("UserManagementApi.Models.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserManagementApi.Models.Assignments.AssignmentSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserManagementApi.Models.StudentProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserManagementApi.Models.Trade", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AcademicTerm", b =>
                {
                    b.HasOne("UserManagementApi.Models.AcademicSession", "AcademicSession")
                        .WithMany("Terms")
            ...
            modelBuilder.Entity("ParentStudent", b =>
                {
                    ...
                    b.HasOne("UserManagementApi.Models.StudentProfile", "Student")
                        .WithMany("Parents")
            ...
            modelBuilder.Entity("UserManagementApi.Models.Assignments.AssignmentSubmission", b =>
                {
                    b.HasOne("UserManagementApi.Models.Assignment", "Assignment")
                    ...
                    b.HasOne("UserManagementApi.Models.StudentProfile", null)
